...
Mario.Character.prototype.Move = function() {
    ...
    var sideWaysSpeed = Enjine.ControllerInput.IsControlActive(Mario.Controls.Shoot) ? 1.2 : 0.6;
    
    if (this.OnGround) {
        if (Enjine.ControllerInput.IsControlActive(Mario.Controls.Down) && this.Large) {
            this.Ducking = true;
        } else {
            this.Ducking = false;
        }
    ...
    if (Enjine.ControllerInput.IsControlActive(Mario.Controls.Jump) || (this.JumpTime < 0 && !this.OnGround && !this.Sliding)) {
        if (this.JumpTime < 0) {
    ...
    if (Enjine.ControllerInput.IsControlActive(Mario.Controls.Left) && !this.Ducking) {
        if (this.Facing === 1) {
            this.Sliding = false;
        }
    ...
    if (Enjine.ControllerInput.IsControlActive(Mario.Controls.Right) && !this.Ducking) {
        if (this.Facing === -1) {
            this.Sliding = false;
        }
        this.Xa += sideWaysSpeed;
    ...
    if ((!Enjine.ControllerInput.IsControlActive(Mario.Controls.Left) && !Enjine.ControllerInput.IsControlActive(Mario.Controls.Right)) || this.Ducking || this.Ya < 0 || this.OnGround) {
        this.Sliding = false;  
    }
    
    if (Enjine.ControllerInput.IsControlActive(Mario.Controls.Shoot) && this.CanShoot && this.Fire && this.World.FireballsOnScreen < 2) {
    ...
    this.CanShoot = !Enjine.ControllerInput.IsControlActive(Mario.Controls.Shoot);
    this.MayJump = (this.OnGround || this.Sliding) && !Enjine.ControllerInput.IsControlActive(Mario.Controls.Jump);
    ...
    if (this.Carried !== null) {
        ...
        if (!Enjine.ControllerInput.IsControlActive(Mario.Controls.Shoot)) {
...
Mario.Character.prototype.Stomp = function(object) {
    ...
    if (object instanceof Mario.Enemy || object instanceof Mario.BulletBill) {
        ...
        if (Enjine.ControllerInput.IsControlActive(Mario.Controls.Shoot) && object.Facing === 0) {
            this.Carried = object;
            object.Carried = true;
        } else {
            Enjine.Resources.PlaySound("kick");
